...
COPY "./src/devopsdaysdc25" "/app/devopsdaysdc25"
...
# Metadata
ARG NAME="devopsdaysdc25"
ARG DESCRIPTION="DevOps 🚀"
ARG TIMESTAMP
ARG COMMIT_HASH
ENV SERVICE="${NAME}"
...
LABEL org.opencontainers.image.url="https://github.com/jonzeolla/devopsdaysdc25"
LABEL org.opencontainers.image.source="https://github.com/jonzeolla/devopsdaysdc25/tree/${COMMIT_HASH}"
